...
type UserStore interface {
	...
	GetUserToken(scope, plainTextToken string) (*User, error)
}
...
func (pg *PostgresUserStore) GetUserToken(scope, plainTextToken string) (*User, error) {
